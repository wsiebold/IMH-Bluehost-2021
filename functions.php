 ...
 */
	...
	function custom_add_google_fonts() {
		wp_enqueue_style( 'custom-google-fonts', 'https://fonts.googleapis.com/css2?family=Oxygen&family=Quattrocento&display=swap', false );
		}
	...
	function html5reset_scripts_styles() {
		...
		wp_enqueue_style( 'style-events', get_template_directory_uri() . '/style-events.css',false,'1.1','all' );
		wp_enqueue_style( 'style-volunteerPublic', get_template_directory_uri() . '/style-volunteerPublic.css',false,'1.1','all' );
		wp_enqueue_style( 'style-patronsitegrids', get_template_directory_uri() . '/style-patronsitegrids.css',false,'1.1','all' );
		wp_enqueue_style( 'style-patronsurveyform', get_template_directory_uri() . '/style-patronsurveyform.css',false,'1.1','all' );
		wp_enqueue_style( 'style-single_survey', get_template_directory_uri() . '/style-single_survey.css',false,'1.1','all' );
...
// old jquery wp_register_script( 'jquery', ( "http://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js" ), false);
// replaced with latest version 3.5.1 below
